...
| `403` | Forbidden | Invalid, revoked, or unauthorized API key |
...
- Header present but missing the `Bearer` prefix or space

---

### 403 Forbidden

The API key is invalid, revoked, expired, or not authorized for the requested resource.
